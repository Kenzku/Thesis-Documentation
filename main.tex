...
% Abstract in English
% ------------------------------------------------------------------
\thesisabstract{english}{Traditional Internet communication technology, HTTP, provides a uni-directional and request/response message exchange model. This conventional solution can be troublesome in web-based Internet of Things (IoT) applications which require real-time and a large amount of information exchange. The WebSocket protocol provides bi-directional communication mechanism through a single socket, which reduces unnecessary communication overhead and redundant TCP connections. The WebSocket Application Messaging Protocol (WAMP), a WebSocket subprotocol, provides two important message exchange patterns -- Publish/Subscribe and Remote Procedure Call -- in the web-based IoT applications. In this thesis, we provide two web-based IoT applications on the scenarios of social sensing and home automation, which are designed based on HTTP communication pattern and the WebSocket with WAMP communication pattern respectively. Among both, we focus on the WebSocket with WAMP solution. Specifically, we compare substituted protocols for the WebSocket. We also measure and evaluate other WebSocket subprotocols compared to WAMP.}
...
\input{2webtechnogies.tex}

\input{3internetofthings.tex}
 
\input{4design-and-implementation-of-web-based-IoT-applications.tex}

\input{5evaluation.tex}
