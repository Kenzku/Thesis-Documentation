...
% Abstract in English
% ------------------------------------------------------------------
\thesisabstract{english}{This thesis addresses the potential communication problems in web-based Internet of Things applications from the perspective of time-sensitive and overhead. With the HTTP request/response pattern, it generates mass overheads and establishes excessive TCP connections in the communication between a browser with a web server. The problem becomes severe when it happens in the scenario of Internet of Things (IoT) with a large amount of devices interconnected. In effort to solve the mass overheads, excessive TCP connections and real time communication problems in IoT, we provide a solution using WebSockets with its sub-protocol, the WebSocket Application Messaging Protocol (WAMP). In the thesis, we defined different patterns for web-based IoT applications suitable for time-sensitive and low overhead communications. Furthermore, we implemented the web-based IoT applications in two relevant scenarios, namely, home automation and social sensing. The thesis also includes the comparison, measurement and evaluation of different technologies and protocols for IoT-based communications.}
