...
% Abstract in English
% ------------------------------------------------------------------
\thesisabstract{english}{This thesis addresses design and performance of in web-based Internet of Things applications. The HTTP request/response pattern, largely used in web applications generates mass overheads and establishes as excessive amount of TCP connections for the communication between a browser and a web server. The problem becomes severe in the scenario of Internet of Things (IoT), in which a large amount of devices interconnected. In order to address scalability and low latency communications in the IoT, we provide a solution by jointly using WebSockets and its the WebSocket Application Messaging Protocol (WAMP) sub-protocol. In this thesis, we define different patterns for web-based IoT applications suitable for time-sensitive and low overhead communications. We implemented web-based IoT applications in two relevant scenarios, namely, home automation and social sensing. The thesis also includes the comparison, measurement and evaluation of different technologies and protocols for IoT-based communications.}
