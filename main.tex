...
\input{2internetofthings.tex}

\input{3webservicesfortheiot.tex}

\input{4Patterns-for-web-based-IoT-applications.tex}
 
\input{5Design-and-implementation-of-sample-IoT-services.tex}

\input{6evaluation.tex}
 
\input{7future-and-conclusion.tex}
